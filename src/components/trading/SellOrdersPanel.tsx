            ...
            >
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="text-right">
                  <div className={`text-xs font-bold ${orden.retorno >= 0 ? 'text-success' : 'text-danger'}`}>
                    {orden.retorno >= 0 ? '+' : ''}{orden.retorno.toFixed(1)}%
                  </div>
              ...
              <div className="grid grid-cols-2 gap-2 text-xs mb-1">
                ...
                <div>
                  ...
                  <span className={`ml-1 font-mono ${orden.gananciaUSD >= 0 ? 'text-success' : 'text-danger'}`}>
                    {orden.gananciaUSD >= 0 ? '+' : ''}${orden.gananciaUSD.toLocaleString()}
                  </span>
                </div>
              </div>
